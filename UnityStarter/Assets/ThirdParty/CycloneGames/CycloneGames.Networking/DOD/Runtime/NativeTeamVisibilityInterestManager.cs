...
namespace CycloneGames.Networking.DOD
{
    ...
    /// </summary>
    public sealed class NativeTeamVisibilityInterestManager : IInterestManager, IDisposable
    {
        ...
        // --- Native data rebuilt each PreUpdate and reused where capacity permits. ---
        ...
        public NativeTeamVisibilityInterestManager(float defaultDetectionRange = 12f,
