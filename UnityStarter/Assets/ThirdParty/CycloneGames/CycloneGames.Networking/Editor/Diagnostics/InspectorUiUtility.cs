...
namespace CycloneGames.Networking.Editor.Diagnostics
{
    internal static class InspectorUiUtility
    {
        ...
        public static void DrawIssue(NetworkBootstrapIssue issue)
        {
            if (issue == null)
                return;
            ...
            {
                NetworkBootstrapIssueSeverity.Error => MessageType.Error,
                NetworkBootstrapIssueSeverity.Warning => MessageType.Warning,
                _ => MessageType.Info
            };
