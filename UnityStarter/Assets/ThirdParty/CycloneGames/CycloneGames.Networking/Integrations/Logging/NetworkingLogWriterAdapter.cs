...
namespace CycloneGames.Networking
{
    ...
    /// </summary>
    public sealed class NetworkingLogWriterAdapter : INetworkingDiagnostics
    {
        public static readonly NetworkingLogWriterAdapter Ambient = new NetworkingLogWriterAdapter();

        private readonly ILogWriter _writer;

        public NetworkingLogWriterAdapter()
        {
        }

        public NetworkingLogWriterAdapter(ILogWriter writer)
        {
