...
A Unity interaction runtime supporting 3D, 2D, and Spatial Hash detection. Powered by R3 for reactive UI, VitalRouter for command routing, and UniTask for async execution.
