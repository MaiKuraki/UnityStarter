...
namespace CycloneGames.RPGFoundation.Runtime
{
    ...
    public class MovementComponent : MonoBehaviour, IMovementStateQuery
    {
        ...
        void Awake()
        {
            ...
            InitializeContext();
            _currentState = StatePool.GetState<IdleState>();
        ...
        private MovementStateBase GetStateByType(MovementStateType stateType)
        {
            switch (stateType)
            {
                case MovementStateType.Idle: return StatePool.GetState<IdleState>();
                case MovementStateType.Walk: return StatePool.GetState<WalkState>();
                case MovementStateType.Run: return StatePool.GetState<RunState>();
                case MovementStateType.Sprint: return StatePool.GetState<SprintState>();
                case MovementStateType.Crouch: return StatePool.GetState<CrouchState>();
                case MovementStateType.Jump: return StatePool.GetState<JumpState>();
                case MovementStateType.Fall: return StatePool.GetState<FallState>();
                default:
