...
namespace CycloneGames.Audio.Editor
{
    ...
    public class AudioPoolConfigEditor : UnityEditor.Editor
    {
        ...
        private SerializedProperty switchMaxPoolSize;
        private SerializedProperty consoleMaxPoolSize;
        ...
        private SerializedProperty switchInitialPoolSize;
        private SerializedProperty consoleInitialPoolSize;
        ...
        private void OnEnable()
        {
            ...
            switchMaxPoolSize = serializedObject.FindProperty("switchMaxPoolSize");
            consoleMaxPoolSize = serializedObject.FindProperty("consoleMaxPoolSize");
            ...
            switchInitialPoolSize = serializedObject.FindProperty("switchInitialPoolSize");
            consoleInitialPoolSize = serializedObject.FindProperty("consoleInitialPoolSize");
        ...
        private void DrawConsoleSection()
        {
            ...
            if (showConsole)
            {
                ...
                DrawSliderWithValue(switchMaxPoolSize, "Switch", 32, 128);
                DrawSliderWithValue(consoleMaxPoolSize, "PS5 / Xbox", 96, 384);
        ...
        private void DrawInitialSizesSection()
        {
            ...
            if (showInitialSizes)
            {
                ...
                DrawSliderWithValue(switchInitialPoolSize, "Switch", 16, 64);
                DrawSliderWithValue(consoleInitialPoolSize, "Console", 32, 128);
