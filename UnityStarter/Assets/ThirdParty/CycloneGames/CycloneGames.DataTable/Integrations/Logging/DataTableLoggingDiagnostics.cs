...
namespace CycloneGames.DataTable
{
    ...
    /// </summary>
    public sealed class DataTableLoggingDiagnostics : IDataTableDiagnostics
    {
        public static readonly DataTableLoggingDiagnostics Ambient = new DataTableLoggingDiagnostics();

        private readonly ILogWriter _writer;

        public DataTableLoggingDiagnostics()
        {
        }

        public DataTableLoggingDiagnostics(ILogWriter writer)
        {
