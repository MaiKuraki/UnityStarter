...
namespace CycloneGames.AIPerception.Runtime
{
    ...
    public sealed class ProximitySensor : ISensor, ISensorManagerOwned, IAIPerceptionSensorMemoryOwner
    {
        ...
        AIPerceptionSensorMemoryStats IAIPerceptionSensorMemoryOwner.GetMemoryStats()
        {
            ...
            int outputCapacity = _jobProximity.IsCreated ? _jobProximity.Length : 0;
            return new AIPerceptionSensorMemoryStats(
                ...
                (_candidateIndices.IsCreated ? 1 : 0) + (_jobProximity.IsCreated ? 1 : 0) +
