...
{
    public sealed class MonoObjectPool<TParam1, TValue> : IMemoryPool<TParam1, TValue>, IDisposable
        where TValue : MonoBehaviour, IPoolable<TParam1, IMemoryPool>, ITickable
    {
        ...
        public MonoObjectPool(IFactory<TValue> factory, int initialSize = 5, bool autoExpand = true)
        {
