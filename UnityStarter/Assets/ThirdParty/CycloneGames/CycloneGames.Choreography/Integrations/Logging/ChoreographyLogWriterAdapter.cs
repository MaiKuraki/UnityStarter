...
namespace CycloneGames.Choreography
{
    ...
    /// </summary>
    public sealed class ChoreographyLogWriterAdapter : IChoreographyDiagnostics
    {
        public static readonly ChoreographyLogWriterAdapter Ambient = new ChoreographyLogWriterAdapter();

        private readonly ILogWriter _writer;

        public ChoreographyLogWriterAdapter()
        {
        }

        public ChoreographyLogWriterAdapter(ILogWriter writer)
        {
