...
namespace CycloneGames.GameplayTags.Core
{
    ...
    public static class Pools
    {
        ...
        {
            private static readonly CustomObjectPool<Dictionary<TKey, TValue>> s_Pool = new CustomObjectPool<Dictionary<TKey, TValue>>(null, d => d.Clear());
            ...
            {
                var pooled = new PooledObject<Dictionary<TKey, TValue>>(Get(), s_Pool);
                value = pooled.Value;
                return pooled;
            }
