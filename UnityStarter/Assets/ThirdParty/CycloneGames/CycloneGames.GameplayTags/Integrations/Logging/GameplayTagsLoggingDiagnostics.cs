...
namespace CycloneGames.GameplayTags
{
    ...
    /// </summary>
    public sealed class GameplayTagsLoggingDiagnostics : IGameplayTagsDiagnostics
    {
        public static readonly GameplayTagsLoggingDiagnostics Ambient = new GameplayTagsLoggingDiagnostics();

        private readonly ILogWriter _writer;

        public GameplayTagsLoggingDiagnostics()
        {
        }

        public GameplayTagsLoggingDiagnostics(ILogWriter writer)
        {
