...
namespace CycloneGames.GameplayTags.Runtime
{
   ...
   public class GameplayTagDefinition
   {
      ...
      /// </summary>
      [DebuggerBrowsable(DebuggerBrowsableState.Never)]
      public ReadOnlySpan<GameplayTag> ParentTags => m_ParentTags != null ? new(m_ParentTags) : GameplayTagManager.GetParentTagsSpan(RuntimeIndex);
      ...
      /// </summary>
      [DebuggerBrowsable(DebuggerBrowsableState.Never)]
      public ReadOnlySpan<GameplayTag> ChildTags => m_ChildTags != null ? new(m_ChildTags) : GameplayTagManager.GetChildTagsSpan(RuntimeIndex);
      ...
      /// </summary>
      [DebuggerBrowsable(DebuggerBrowsableState.Never)]
      public ReadOnlySpan<GameplayTag> HierarchyTags => m_HierarchyTags != null ? new(m_HierarchyTags) : GameplayTagManager.GetHierarchyTagsSpan(RuntimeIndex);
      ...
      public bool IsChildOf(GameplayTag tag)
      {
         ...
         if (IsValid)
            return GameplayTagManager.IsChildOf(RuntimeIndex, tag.RuntimeIndex);
      ...
      public bool IsParentOf(GameplayTag tag)
      {
         ...
         if (IsValid)
            return GameplayTagManager.IsParentOf(RuntimeIndex, tag.RuntimeIndex);
      ...
      internal void OptimizeRuntimeStorage()
      {
         if (RuntimeIndex <= 0)
            return;
