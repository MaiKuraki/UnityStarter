...
namespace CycloneGames.GameplayTags.Runtime
{
   ...
   public class GameplayTagRegistrationContext
   {
      ...
      internal GameplayTagRegistrationContext(List<GameplayTagDefinition> existingDefinitions)
      {
      ...
      internal List<GameplayTagDefinition> GenerateDefinitions(bool addNoneTag)
      {
