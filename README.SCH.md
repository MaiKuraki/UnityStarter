...
- **[BehaviorTree](UnityStarter/Assets/ThirdParty/CycloneGames/CycloneGames.BehaviorTree)** - 行为树系统，用于 AI。支持组合/装饰/动作节点的复杂逻辑，基于 ScriptableObject 设计便于编写，针对移动端/低端设备进行了优化。
...
- **程序动画**: [LitMotion](https://github.com/annulusgames/LitMotion)
